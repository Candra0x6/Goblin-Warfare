...
{ 
    ...
    public void drawHealth(){
        ...
        double currentReload = (double) ((PlayerGunAmmo) getWorld().getObjects(PlayerGunAmmo.class).get(0)).getCounter();
        double maxReload = (double) ((PlayerGunAmmo) getWorld().getObjects(PlayerGunAmmo.class).get(0)).getReload();
        int currWeap = ((PlayerGunAmmo) getWorld().getObjects(PlayerGunAmmo.class).get(0)).getWeap();

        double currAmmo = ((PlayerGunAmmo) getWorld().getObjects(PlayerGunAmmo.class).get(0)).getCurrAmmo();
        double maxAmmo = ((PlayerGunAmmo) getWorld().getObjects(PlayerGunAmmo.class).get(0)).getMaxAmmo();
        //draws bar
        buffer++;
        if(buffer % 2 == 0){
